 ...
 */
public class SubscribeAdapter<E extends SubscribeItem> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    // 我的频道 标题部分
    ...
    private List<E> mMyChannelItems, mOtherChannelItems;

    public List<E> getMyChannelItems() {
        return mMyChannelItems;
    }

    public List<E> getOtherChannelItems() {
    ...
    public SubscribeAdapter(Context context, ItemTouchHelper helper, List<E> mMyChannelItems,
                            List<E> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.lib_layout_subscribe_item_my_channel_header, parent, false);
                ...
                holder.tvBtnBack.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        cancelEditMode((RecyclerView) parent);
                        holder.tvBtnEdit.setText("编辑");
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.lib_layout_subscribe_item_my, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.lib_layout_subscribe_item_other_channel_header, parent, false);
                return new RecyclerView.ViewHolder(view) {
                };

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.lib_layout_subscribe_item_other, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myHolder.isFix = checkIsFix(position);
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        E item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        E item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        E item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    private boolean checkIsFix(int index) {
        if (index > COUNT_PRE_MY_HEADER - 1 && index < mMyChannelItems.size() + 1) {
            return mMyChannelItems.get(index - 1).getIsFix() == 1;
        }
        return false;
    }
    ...
    static class MyChannelHeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyChannelHeaderViewHolder(View itemView) {
            ...
            tvBtnBack = (TextView) itemView.findViewById(R.id.tv_btn_back);
        }
    }
}
